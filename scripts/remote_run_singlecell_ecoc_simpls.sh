...
VARIANTS="${FASTPLS_ECOC_VARIANTS:-cpp_rsvd,cpp_irlba,cuda}"
RESPONSE_MODES="${FASTPLS_ECOC_RESPONSE_MODES:-onehot,random_ecoc50,balanced_ecoc50,hadamard_ecoc50,orthogonal_random50,centroid_pca50}"
