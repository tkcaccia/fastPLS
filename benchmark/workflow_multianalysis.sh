...
export FASTPLS_NMR_NCOMP_LIST="${FASTPLS_NMR_NCOMP_LIST:-2,5,10,20,50,100,200,500}"
export FASTPLS_SINGLECELL_NCOMP_LIST="${FASTPLS_SINGLECELL_NCOMP_LIST:-2,5,10,20,50}"
export FASTPLS_CCLE_NCOMP_LIST="${FASTPLS_CCLE_NCOMP_LIST:-2,5,10,18,50,100}"
export FASTPLS_CIFAR100_NCOMP_LIST="${FASTPLS_CIFAR100_NCOMP_LIST:-2,5,10,20,50,100,200}"
export FASTPLS_GTEX_PAN_PRISM_NCOMP_LIST="${FASTPLS_GTEX_PAN_PRISM_NCOMP_LIST:-2,5,10,20,32,50,100}"
