...
variant_specs <- function() {
  rows <- list(
    ...
    c("gpu_plssvd_flash_fp64", "plssvd", "GPU", "flash_svd", "CUDA flash"),
    ...
    c("gpu_simpls_flash_fp64", "simpls", "GPU", "flash_svd", "CUDA flash"),
    ...
    c("gpu_kernelpls_flash_fp64", "kernelpls", "GPU", "flash_svd", "CUDA flash"),
    ...
    c("gpu_opls_flash_fp64", "opls", "GPU", "flash_svd", "CUDA flash"),
