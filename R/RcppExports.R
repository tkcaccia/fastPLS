...
label_crossprod_scaled_cpp <- function(XtrainSEXP, y, n_classes, scaling) {
    .Call(`_fastPLS_label_crossprod_scaled_cpp`, XtrainSEXP, y, n_classes,
        scaling)
}
...
kernel_matrix_float32_cpp <- function(X1SEXP, X2SEXP, kernel, gamma, degree,
    coef0, backend) {
    .Call(`_fastPLS_kernel_matrix_float32_cpp`, X1SEXP, X2SEXP, kernel, gamma,
        degree, coef0, backend)
}
...
center_kernel_test_float32_cpp <- function(KtestSEXP, trainColMeansSEXP,
    train_grand_mean) {
    .Call(`_fastPLS_center_kernel_test_float32_cpp`, KtestSEXP,
        trainColMeansSEXP, train_grand_mean)
}

opls_filter_float32_cpp <- function(XSEXP, YSEXP, north, scaling, backend,
    svd_method, rsvd_oversample, rsvd_power, seed) {
    .Call(`_fastPLS_opls_filter_float32_cpp`, XSEXP, YSEXP, north, scaling,
        backend, svd_method, rsvd_oversample, rsvd_power, seed)
}

opls_apply_filter_float32_cpp <- function(XSEXP, mXSEXP, vXSEXP, WSEXP, PSEXP,
    backend) {
    .Call(`_fastPLS_opls_apply_filter_float32_cpp`, XSEXP, mXSEXP, vXSEXP,
        WSEXP, PSEXP, backend)
}

lda_train_prefix_float32_cpp <- function(TtrainSEXP, y, n_classes, ncomp) {
    .Call(`_fastPLS_lda_train_prefix_float32_cpp`, TtrainSEXP, y, n_classes,
        ncomp)
}
...
lda_train_prefix_float32_cuda <- function(TtrainSEXP, y, n_classes, ncomp) {
    .Call(`_fastPLS_lda_train_prefix_float32_cuda`, TtrainSEXP, y, n_classes,
        ncomp)
}
...
metal_float32_matrix_multiply_cpp <- function(ASEXP, BSEXP,
    transpose_left = FALSE, transpose_right = FALSE) {
    .Call(`_fastPLS_metal_float32_matrix_multiply_cpp`, ASEXP, BSEXP,
...
fastsvd_float32_cpp <- function(ASEXP, k, backend, svd_method, rsvd_oversample,
    rsvd_power, seed, left_only = FALSE) {
    .Call(`_fastPLS_fastsvd_float32_cpp`, ASEXP, k, backend, svd_method,
        rsvd_oversample, rsvd_power, seed, left_only)
}

pls_float32_cpu_cpp <- function(XtrainSEXP, YtrainSEXP, ncomp, scaling, fit,
...
lda_train_moments_prefix_cpp <- function(gram, class_sums, counts, n, ncomp) {
    .Call(`_fastPLS_lda_train_moments_prefix_cpp`, gram, class_sums, counts, n,
        ncomp)
}

lda_project_train_prefix_cpp <- function(Xtrain, R, offset, y, n_classes,
    ncomp, ridge) {
    .Call(`_fastPLS_lda_project_train_prefix_cpp`, Xtrain, R, offset, y,
        n_classes, ncomp, ridge)
}
...
lda_project_train_prefix_cuda <- function(Xtrain, R, offset, y, n_classes,
    ncomp, ridge) {
    .Call(`_fastPLS_lda_project_train_prefix_cuda`, Xtrain, R, offset, y,
        n_classes, ncomp, ridge)
}
...
lda_project_predict_cuda <- function(Xtest, R, offset, lda,
    return_scores = FALSE) {
    .Call(`_fastPLS_lda_project_predict_cuda`, Xtest, R, offset, lda,
        return_scores)
}

truncated_svd_debug <- function(A, k, svd_method, rsvd_oversample, rsvd_power,
    svds_tol, seed, left_only) {
    .Call(`_fastPLS_truncated_svd_debug`, A, k, svd_method, rsvd_oversample,
        rsvd_power, svds_tol, seed, left_only)
}

pls_model2 <- function(Xtrain, Ytrain, ncomp, scaling, fit, svd_method,
    rsvd_oversample, rsvd_power, svds_tol, seed) {
    .Call(`_fastPLS_pls_model2`, Xtrain, Ytrain, ncomp, scaling, fit,
        svd_method, rsvd_oversample, rsvd_power, svds_tol, seed)
}

pls_model2_fast <- function(Xtrain, Ytrain, ncomp, scaling, fit, svd_method,
    rsvd_oversample, rsvd_power, svds_tol, seed) {
    .Call(`_fastPLS_pls_model2_fast`, Xtrain, Ytrain, ncomp, scaling, fit,
        svd_method, rsvd_oversample, rsvd_power, svds_tol, seed)
}

pls_model2_fast_gpu <- function(Xtrain, Ytrain, ncomp, scaling, fit,
    svd_method, rsvd_oversample, rsvd_power, svds_tol, seed) {
    .Call(`_fastPLS_pls_model2_fast_gpu`, Xtrain, Ytrain, ncomp, scaling, fit,
        svd_method, rsvd_oversample, rsvd_power, svds_tol, seed)
}

pls_model2_fast_gpu_labels <- function(XtrainSEXP, y, n_classes, ncomp,
...
pls_class_predict_topk_cpp <- function(model, Xtest, top_k, proj, block_size) {
    .Call(`_fastPLS_pls_class_predict_topk_cpp`, model, Xtest, top_k, proj,
        block_size)
}
...
center_kernel_test_cpp <- function(Ktest, train_col_means, train_grand_mean) {
    .Call(`_fastPLS_center_kernel_test_cpp`, Ktest, train_col_means,
        train_grand_mean)
}
...
single_pls_cv_cpp <- function(Xdata, Ydata, constrain, ncomp, scaling, kfold,
...
pls_model1 <- function(Xtrain, Ytrain, ncomp, scaling, fit, svd_method,
    rsvd_oversample, rsvd_power, svds_tol, seed) {
    .Call(`_fastPLS_pls_model1`, Xtrain, Ytrain, ncomp, scaling, fit,
        svd_method, rsvd_oversample, rsvd_power, svds_tol, seed)
}

pls_model1_rsvd_xprod_precision <- function(Xtrain, Ytrain, ncomp, scaling,
...
pls_model1_gpu <- function(Xtrain, Ytrain, ncomp, scaling, fit, svd_method,
    rsvd_oversample, rsvd_power, svds_tol, seed) {
    .Call(`_fastPLS_pls_model1_gpu`, Xtrain, Ytrain, ncomp, scaling, fit,
        svd_method, rsvd_oversample, rsvd_power, svds_tol, seed)
}

pls_model1_gpu_implicit_xprod <- function(Xtrain, Ytrain, ncomp, scaling, fit,
    rsvd_oversample, rsvd_power, svds_tol, seed) {
    .Call(`_fastPLS_pls_model1_gpu_implicit_xprod`, Xtrain, Ytrain, ncomp,
        scaling, fit, rsvd_oversample, rsvd_power, svds_tol, seed)
}
...
fastpls_cpp_core_rsvd <- function(A, k, oversample = 20L, power = 2L,
    seed = 1L, use_float = FALSE) {
    .Call(`_fastPLS_fastpls_cpp_core_rsvd`, A, k, oversample, power, seed,
        use_float)
}

fastpls_cpp_core_plssvd <- function(X, Y, ncomp, oversample = 20L, power = 2L,
    seed = 1L, use_float = FALSE) {
    .Call(`_fastPLS_fastpls_cpp_core_plssvd`, X, Y, ncomp, oversample, power,
        seed, use_float)
}

fastpls_cpp_core_simpls <- function(X, Y, ncomp, oversample = 20L, power = 2L,
    seed = 1L, use_float = FALSE) {
    .Call(`_fastPLS_fastpls_cpp_core_simpls`, X, Y, ncomp, oversample, power,
        seed, use_float)
}
...
metal_simpls_resident_cpp <- function(X, Y, ncomp, power_iters = 2L,
    seed = 1L) {
